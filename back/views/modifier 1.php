<?php
    include_once '../model/user 1.php ';
    include_once '../controller/userc 1.php';
    ...
    if (
       ...
       {if (
            ...
            
         {
            ...
            $userc->modifier($usee, $_POST["typeform"]);
...
<form action="" method="POST">
            <table border="1" align="center">
                <tr>
                    ...
                    <td><input type="number" name="experience" id="experience" value="<?php echo $usee['experience']; ?>" maxlength="20"></td>
                </tr>
				
                <tr>
                    <td>
                        <label for="typeform">typeform:
                        </label>
                    </td>
                    <td>
                        <input type="text" name="typeform" id="typeform" value="<?php echo $usee['typeform']; ?>"></td>
