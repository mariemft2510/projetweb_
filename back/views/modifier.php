...
<?php
                if (isset($_GET['Id'])){
                    $usee= $userc->recupererUser($_GET['Id']);
                }
...
<form action="" method="POST">
            <table border="1" align="center">
				...
				<tr>
                    ...
                    <td><input type="text" name="Nom" id="Nom" value="" maxlength="20"></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="text" name="Prenom" id="Prenom" value="" maxlength="20"></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="text" name="Passwor" value="" id="Passwor">
                    </td>
                </tr>
                <tr>
                    <td>
