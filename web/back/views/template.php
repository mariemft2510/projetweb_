...
<div class="line" align="center">
   ...
   <div class="s-12 l-6" align="center">
      ...
      <form class="customform" action="" method="post" >
         <div  class="s-12 l-7" align="center" ><input name="CodeAn" placeholder="Code de l'annonce" title="Your e-mail" type="text" /></div>
         <div class="s-12 l-7" align="center" ><input name="TypeAn" placeholder="Type de l'annonce" title="Your name" type="text" /></div>
         <div class="s-12 l-7" align="center" ><input name="TitreAn" placeholder="Titre de l'annonce" title="Your name" type="texte" /></div>
         <div class="s-12 l-7" align="center" ><input name="DateAn" placeholder="Date de l'annonce" title="Your name" type="date" /></div>
         
         <div class="s-12" align="center" ><textarea placeholder="Cntenue de l'annonce" name="ContenueAn" rows="5"></textarea></div>
         <div class="s-12 m-6 l-4" align="center" ><button type="valider">Ajouter annonce</button></div>
